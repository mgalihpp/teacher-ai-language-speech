const socialInfo = [
  {
    icon: (
      <svg
        className="h-6 w-6 duration-150 hover:text-stone-500"
        fill="none"
        viewBox="0 0 48 48"
      >
        <g clipPath="url(#a)">
...
const Footer = () => (
  <footer className="pt-16">
    <div className="mx-auto w-full max-w-screen-lg">
      <div className="mt-10 items-center justify-between border-t px-4 py-10 sm:flex">
        <p className="text-stone-600 dark:text-stone-300">
          © 2024 by mgalihpp. All rights reserved.
        </p>
        <div className="mt-6 flex items-center gap-x-6 text-stone-400">
